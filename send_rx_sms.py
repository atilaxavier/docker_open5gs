...
def received_handler(pdu):
	print("received_handler - Recebido: %s"%pdu.sequence) 
...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(description='send_rx_sms.py. Rotina para envio de SMS sobre SMPP com OsmoSMSC.')
